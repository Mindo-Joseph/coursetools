...
const SeoHead = (props) => {
    ...
    return (<Head>
        ...
        meta.date && (<>
            ...
            <meta name='author' property='article:author'
                content={
                    meta.author
                }/>
        </>)
        ...
        {/* Favicons */}
        {
        favicons.map((linkProps) => (<link key={
                linkProps.href
            }
            {...linkProps}/>))
    }
        ...
        <meta name='msapplication-TileImage' content='/favicon/ms-icon-144x144.png'/> {/* Accent color on supported browser */}
